...
plot_resume <- function(resume_df, project_df, seed=42) {
  ########################################
  # read in resume data and clean data
  ########################################
  resume_data <- resume_df %>%
...
plot_resume_lexRankr_annotation <- function(resume_df, project_df, seed=42) {
  no_annotations_plotly <- plot_resume(resume_df, project_df, seed=seed)
